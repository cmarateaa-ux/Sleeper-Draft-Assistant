...
function projection(seasonRow, marketRow, scoring) {
  ...
  // Sleeper's scoring-specific ADP is the market number shown by the draft room.
  // Prefer adp_ppr / adp_half_ppr / adp_std. The adp_dd_* fields are dynasty/other
  // market data and can materially differ from the live redraft ADP (e.g. Olave ~30 vs ~18).
